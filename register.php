	  ...
	  <?php
		if(isset($_GET['error'])){
			...
			<div class="row center">
				<h5 class="header col s12 light"><?php echo $_GET['error'] ?></h5>
			</div>
	  <?php
		}
	  ?>
		   ...
		   <div class="row">
				<form class="col s12" action="registerAction.php" method="post">
				  ...
				  <div class="row">
					...
					<div class="input-field col s6">
						<input placeholder="Secret" id="password" name="password" type="password" class="validate">
						<label for="password">Password</label>
					</div>
				  </div>
				  
					<div class="row">	
					  <button class="btn-large waves-effect waves-light" type="submit" name="action">Let's go !</button>
					</div>
